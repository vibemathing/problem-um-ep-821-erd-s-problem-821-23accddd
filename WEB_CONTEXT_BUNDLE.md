...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-821-erd-s-problem-821-23accddd-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-821"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-821-erd-s-problem-821-23accddd-v1",
      "problem_contract_sha256": "2edb46c504b1ea22e4bf40bce38d872b0f8f9be44790cce70ee28a2b36a0309c",
      "problem_id": "problem:um-ep-821-erd-s-problem-821-23accddd",
      "route_id": "route:um-ep-821-erd-s-problem-821-23accddd-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-821-erd-s-problem-821-23accddd-source-fidelity-01",
      "graph_id": "graph:um-ep-821-erd-s-problem-821-23accddd-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-821-erd-s-problem-821-23accddd-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-821-erd-s-problem-821-23accddd-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $g(n)$ count the number of $m$ such that $\\phi(m)=n$. Is it true that, for every $\\epsilon>0$, there exist infinitely many $n$ such that $ g(n) > n^{1-\\epsilon}? $"
          },
          "statement_sha256": "0dfae5bd37a50c9a1d2b7eb3331668937500fe9b3876e5a1e9aa8ef33a56b54d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-821-erd-s-problem-821-23accddd-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-821-erd-s-problem-821-23accddd-root",
      "route_id": "route:um-ep-821-erd-s-problem-821-23accddd-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-821-cb4b70d5ea36",
        "url": "https://www.unsolvedmath.com/problems/EP-821"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
